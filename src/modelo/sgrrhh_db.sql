...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Deposito del Tipo de Documentos';
...
CREATE TABLE IF NOT EXISTS `rhlq_liquidacion` (
  ...
  `liq_obs` int(100) DEFAULT NULL COMMENT 'Observacion'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Deposito de Liquidacion';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Deposito de Persona';
...
(2, '789654', 'Ariel', 'Britez', '1985-07-04', 'Paraguaya', NULL, NULL, '1', '1', NULL, NULL, NULL, '1', 0, ''),
(3, '3456885', 'CARLOS', 'PEREZ', '1975-04-21', 'PARAGUAYA', 'EUSEBIO AYALA 2373', 'ASUNCION', 'Casado/a', 'Masculino', '021736494', 'CPEREZ@gmail.com', '', 'Activo', 0, ''),
...
--
ALTER TABLE `rhco_tipodocumento`
  MODIFY `tdo_cod` int(15) NOT NULL AUTO_INCREMENT COMMENT 'Codigo',AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `rhrl_persona`
  MODIFY `per_cod` int(15) NOT NULL AUTO_INCREMENT COMMENT 'Codigo',AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `rhrl_persona`
  ADD CONSTRAINT `fk_tipodocumento` FOREIGN KEY (`per_codtpdocu`) REFERENCES `rhco_tipodocumento` (`tdo_cod`) ON DELETE NO ACTION ON UPDATE NO ACTION;
